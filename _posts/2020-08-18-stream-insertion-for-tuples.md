...
[^misuse]: This helper function is not intended as part of a public API, which is why it's placed in its own namespace. However, it makes a lot of sense to guard it against accidental misuse by the implementor, too.
