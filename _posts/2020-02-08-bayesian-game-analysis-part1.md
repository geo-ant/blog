...
* we could already have collected data and our prior is the posterior probability which we calculated last time,
...
Here we have effectively only maximized the likelihood term. This is why our $$p=N_W/N$$ is called the maximum likelihood estimator for the Binomial Distribution.
